...
import { IndianRupee, LoaderCircleIcon, Plus } from 'lucide-react'
...
const ExpensePage = () => {
  ...
  console.log("🚀 ~ ExpensePage ~ expenseCategory:", expenseCategory)
      ...
      {!isLoading ? (
        <>
          <section className="bg-white shadow-lg w-2/5 my-3 ml-3 p-3 space-y-3">
            ...
            <div className="overflow-y-scroll scroll-smooth h-[82dvh]">
              <Table>
                <TableHeader>
                  <TableRow>
            ...
            <div className=" bg-white shadow-lg p-3 h-full space-y-2">
              ...
              <div className="overflow-y-scroll h-[76dvh]">
                <Table>
                  ...
                  <TableBody>
                    {typeof selectedData?.[0] === 'object' &&
                      selectedData?.[0]?.expense_category
                        ?.filter((item) =>
                          item.item
                            ?.toLowerCase()
