...
const PartyPage = () => {
  ...
  console.log('🚀 ~ PartyPage ~ invoiceData:', invoiceData)
      ...
      {!isLoading ? (
        <>
          <section className="bg-white shadow-lg w-1/4 my-3 ml-3 p-3 space-y-3">
            ...
            {/* <div className="flex font-semibold">Filter Party </div> */}
            <div>
              <Table>
                <TableHeader>
                  <TableRow>
              ...
              <div className="flex justify-between">
                ...
                {selectProduct && (
                  <div className=" flex gap-2">
                    <Button
                      onClick={() => open('PaymentIn', selectProduct[0].id)}
                    >
                      <IndianRupee />
                      Take Payment
                    </Button>
                      ...
                      invoiceData
                        ...
                        .map((item, index) => (
                          <TableRow key={item?.id}>
                            ...
                            <TableCell>
                              {item?.invoice_type === 'payment_in'
                                ? `Take payment by ${item.payment?.account_name}`
                                : item.billing_name}
                            </TableCell>
                            ...
                            <TableCell
                              className={
                                item.invoice_type === 'payment_in'
                                  ...
                                  : ' text-neutral-600 font-semibold text-right'
                              }
                            >
                              {' '}
